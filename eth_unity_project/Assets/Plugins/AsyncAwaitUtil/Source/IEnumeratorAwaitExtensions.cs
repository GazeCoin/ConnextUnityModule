...
#pragma warning restore CS0618
    ...
    public static SimpleCoroutineAwaiter<Coroutine> GetAwaiter(this Coroutine coroutine) 
    {
        var awaiter = new SimpleCoroutineAwaiter<Coroutine>();
        RunOnUnityScheduler(() => AsyncCoroutineRunner.Instance.StartCoroutine(
            InstructionWrappers.ReturnSelf<Coroutine>(awaiter, coroutine)));
        return awaiter;
    }
